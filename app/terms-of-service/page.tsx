...
.nav-cta:hover { background: #A00E19; }

.container { max-width: 1200px; width: 100%; margin: 0 auto; padding: 0 24px; }

.page-wrap { display: grid; grid-template-columns: 220px 1fr; gap: 64px; padding: 64px 0 100px; }
...
.sidebar-links a:hover { color: var(--text); background: var(--bg-card); }
.sidebar-links a.active { color: var(--text); border-left-color: var(--red); background: var(--bg-card); }

.policy-content {}

.policy-header { margin-bottom: 56px; }
.policy-label {
...
.policy-meta { font-size: 13px; color: var(--text-dim); }

.policy-section { margin-bottom: 44px; scroll-margin-top: 100px; }
...
.policy-list { list-style: none; display: flex; flex-direction: column; gap: 8px; margin: 10px 0; }
.policy-list li {
...
.callout p { font-size: 14px; color: var(--text-muted); margin-bottom: 0; line-height: 1.65; }
...
.contact-block p { font-size: 15px; color: var(--text-muted); margin-bottom: 8px; line-height: 1.6; }
.contact-block p:last-child { margin-bottom: 0; }
.contact-block a { color: var(--red); text-decoration: none; }
...
.footer-logo-text { font-weight: 700; font-size: 14px; color: var(--text); }
...
@media (max-width: 900px) {
  .page-wrap { grid-template-columns: 1fr; gap: 0; padding: 48px 0 80px; }
